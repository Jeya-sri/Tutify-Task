(function(window) {
    ...
    function Controller(model, view) {
        ...
        that.view.bind('itemDelete', function(item) {
            that.deleteItem(item.id); // bind delete to delete function.
        });
    }
    ...
    Controller.prototype.deleteItem = function(id) { // creating delete function, deleting and rendering.
        var that = this;
        that.model.delete(id, function() {
            that.view.render('deleteItem', id);
        });
        that._filter();
